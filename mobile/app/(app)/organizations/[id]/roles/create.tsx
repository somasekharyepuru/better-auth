...
import { ROLE_TEMPLATES, RESERVED_ROLES, formatRoleName } from '../../../../../src/lib/permissions';
...
export default function CreateRoleScreen() {
  ...
  const validateRoleName = (name: string): string | null => {
    ...
    if (RESERVED_ROLES.includes(name.trim().toLowerCase() as typeof RESERVED_ROLES[number])) {
  ...
  const confirmCreateRole = async () => {
    ...
    try {
      ...
      const response = await fetch(`${apiUrl}/api/organizations/${orgId}/roles`, {
        method: 'POST',
        headers: {
  ...
  return (
    ...
    >
      ...
      <View style={[styles.header, { borderBottomColor: colors.border }]}>
        <Text style={[styles.title, { color: colors.foreground }]}>Create Custom Role</Text>
      ...
      <View style={[styles.tabContainer, { borderBottomColor: colors.border }]}>
        <Pressable
          style={[styles.tab, activeTab === 'permissions' && { borderBottomColor: colors.primary }]}
          onPress={() => setActiveTab('permissions')}
        >
          <Text
            style={[
              styles.tabText,
              { color: activeTab === 'permissions' ? colors.primary : colors.mutedForeground },
            ]}
          >
            Permissions
          </Text>
        ...
        <Pressable
          style={[styles.tab, activeTab === 'templates' && { borderBottomColor: colors.primary }]}
      ...
      <ScrollView style={styles.content} keyboardShouldPersistTaps="handled">
        ...
        <View style={styles.section}>
          <Text style={[styles.label, { color: colors.foreground }]}>Role Name</Text>
          <TextInput
