                    ...
                    <div className="date-picker-calendar bg-white dark:bg-gray-900 rounded-2xl shadow-2xl border border-gray-100 dark:border-gray-800 p-4 backdrop-blur-xl">
                        <DayPicker
                            ...
                            classNames={{
                                ...
                                today: "[&>button]:ring-2 [&>button]:ring-blue-500 [&>button]:ring-offset-1 dark:[&>button]:ring-blue-400",
                                selected: "[&>button]:!bg-blue-600 [&>button]:!text-white dark:[&>button]:!bg-blue-500 [&>button]:hover:!bg-blue-700 dark:[&>button]:hover:!bg-blue-600 [&>button]:font-semibold",
