            ...
            <div className="relative bg-white dark:bg-gray-800 rounded-2xl shadow-2xl w-full max-w-lg mx-4 overflow-hidden">
                ...
                <div className="flex items-center justify-between p-6 border-b border-gray-100 dark:border-gray-700">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h2 className="text-lg font-semibold text-gray-900 dark:text-white">End of Day Review</h2>
                            <p className="text-sm text-gray-500 dark:text-gray-400">Reflect on today and plan ahead</p>
                        </div>
                    </div>
                    <button
                        onClick={onClose}
                ...
                <div className="p-6 space-y-6">
                    ...
                    {incompletePriorities.length > 0 && (
                        <div className="p-4 bg-amber-50 dark:bg-amber-900/20 rounded-xl border border-amber-200 dark:border-amber-800">
                            ...
                            <ul className="text-sm text-amber-700 dark:text-amber-300 mb-3 space-y-1">
                    ...
                    <div>
                        ...
                        <textarea
                            ...
                            className="w-full bg-gray-50 dark:bg-gray-700 rounded-xl p-4 text-gray-700 dark:text-gray-200 outline-none resize-none placeholder:text-gray-400 dark:placeholder:text-gray-500 focus:bg-gray-100 dark:focus:bg-gray-600 transition-colors h-24"
                        />
                    </div>
                ...
                {/* Footer */}
                <div className="flex justify-end gap-3 p-6 border-t border-gray-100 dark:border-gray-700 bg-gray-50 dark:bg-gray-800/50">
                    <button
                        onClick={onClose}
                    ...
                    <button
                        onClick={handleSave}
                        disabled={isLoading}
                        className="px-4 py-2 bg-gray-900 dark:bg-white text-white dark:text-gray-900 rounded-lg hover:bg-gray-800 dark:hover:bg-gray-100 disabled:opacity-50"
                    >
