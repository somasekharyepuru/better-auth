...
export default function DecisionLogPage() {
    ...
    }, [searchQuery, selectedLifeAreaId, dateFrom, dateTo, sortBy, sortOrder, isAuthenticated, loadDecisions]);
    ...
    const hasActiveFilters = selectedLifeAreaId || dateFrom || dateTo || sortBy !== "date" || sortOrder !== "desc";
                ...
                <div className="flex items-center gap-4 mb-8">
                    ...
                    <div className="flex-1">
                        ...
                        <p className="text-sm text-muted">
                            Track important decisions across life areas • {pagination.total} total
                        </p>
                    </div>
                    {!isAdding && (
                        <button
                ...
                {isAdding && (
                    <div className="card-premium mb-6">
                        ...
                        <div className="flex justify-end gap-2 pt-4 border-t border-gray-100 dark:border-gray-700 mt-4">
                            ...
                            >
                                {isSubmitting ? "Saving..." : editingId ? "Update Decision" : "Save Decision"}
                            </button>
                        </div>
                    </div>
                )}
                        ...
                        {showFilters && (
                            <div className="card-premium">
                                <div className="flex items-center justify-between mb-4">
                                    <h4 className="font-medium text-gray-900 dark:text-gray-100">Filters</h4>
                                    {hasActiveFilters && (
                                        <button
