    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <div className="bg-gradient-to-r from-purple-600 via-indigo-600 to-blue-600 text-white">
        <div className="max-w-4xl mx-auto px-4 pt-6">
          {/* Breadcrumb - styled for dark background */}
      ...
      <div className="max-w-4xl mx-auto px-4 py-8 space-y-4">
        ...
        <div id="dashboard">
          ...
          >
            <div className="space-y-4">
              <p className="text-gray-600 dark:text-gray-400">
                Your command center for daily productivity. View priorities,
                time blocks, and progress in one place.
              </p>
              ...
              <div className="space-y-3">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600 dark:text-gray-400">
                      Focus on what matters most today. Add up to 3 priority
                      items.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600 dark:text-gray-400">
                      Reflect on progress and plan for tomorrow.
                    </p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600 dark:text-gray-400">
                      Organize priorities by area (Work, Personal, Health,
                      etc.).
                    </p>
                  </div>
                </div>
              ...
              <div className="p-4 bg-blue-50 dark:bg-blue-900/20 rounded-lg mt-4">
                <p className="text-sm text-blue-800 dark:text-blue-200">
                  <strong>Pro Tip:</strong> Use the arrow buttons or date picker
                  to navigate between days and plan ahead.
                </p>
              </div>
            </div>
          </CollapsibleSection>
        ...
        <div id="tools">
          ...
          >
            <div className="space-y-4">
              <p className="text-gray-600 dark:text-gray-400">
                Specialized tools to boost your productivity and decision
                making.
              </p>
