/**
 * Permission definitions for role-based access control (Admin Portal)
 * Shared types and constants for permission management
 */
...
export const ROLE_TEMPLATES: Record<
  string,
  { name: string; permissions: Permission; description: string; emoji: string }
> = {
  read_only: {
    name: 'read-only',
    permissions: {
