...
function ToastItem({ toast }: { toast: Toast }) {
  ...
  const iconColors = {
    success: "text-chart-1 dark:text-emerald-400",
    error: "text-destructive",
    info: "text-muted-foreground",
    warning: "text-accent-foreground dark:text-amber-400",
  };

  return (
    <div
      className={clsx(
        "flex items-center gap-3 px-4 py-3 bg-card rounded-2xl shadow-lg border border-border/60 backdrop-blur-xl transition-all duration-200 ease-out",
        isVisible && !isLeaving
